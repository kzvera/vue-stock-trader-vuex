        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <div class="pull-right">
                    <button class="btn btn-info" @click="placeSellOrder" :disabled="insufficientQuantity || quantity <= 0 || !Number.isInteger(quantity)">{{ insufficientQuantity ? 'Too Many Stocks' : 'Sell'}}</button>
                </div>
            </div>
        </div>
    </div>
